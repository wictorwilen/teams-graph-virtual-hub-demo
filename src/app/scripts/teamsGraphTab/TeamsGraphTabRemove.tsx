...
export interface ITeamsGraphTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface ITeamsGraphTabRemoveProps {

}

/**
 * Implementation of teams graph Tab remove page
 */
export class TeamsGraphTabRemove  extends TeamsBaseComponent<ITeamsGraphTabRemoveProps, ITeamsGraphTabRemoveState> {
